...
// .wrangler/tmp/bundle-SFMnVc/checked-fetch.js
...
// .wrangler/tmp/pages-GpquVU/chunks/_/error-500.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/client.manifest.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/entry-styles.C-NqyOLw.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-404-styles-1.mjs-DaBoFDuU.mjs
var a;
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-404-styles.WpyeoFtc.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-500-styles-1.mjs-D_pjx06j.mjs
var t2;
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-500-styles.BFuVBFDJ.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-404-styles.CibK9Qn2.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-500-styles.JhxDD0mW.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/styles.mjs
var styles_exports = {};
...
// .wrangler/tmp/pages-GpquVU/chunks/build/_plugin-vue_export-helper-rOXEZKYo.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-404-CcUH1itg.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/error-500-CTl04f3M.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/build/server.mjs
var server_exports = {};
...
var Z, ee, te2, getContext, ne, ae, oe, re, se, ie, le, ue, useRouter, navigateTo, ce, useError, showError, createError2, de, pe, fe, ve, he, ye, ge, me, xe, _e, isDefer, we, be, Ce, Re, Pe, ke, Ae, entry$1;
var init_server = __esm({
  ".wrangler/tmp/pages-GpquVU/chunks/build/server.mjs"() {
    ...
    globalThis.$fetch || (globalThis.$fetch = $e.create({ baseURL: baseURL() }));
    ...
    Ce = { __name: "nuxt-error-page", __ssrInlineRender: true, props: { error: Object }, setup(e6) {
      const t4 = e6.error;
    ...
    Pe = { __name: "nuxt-root", __ssrInlineRender: true, setup(e6) {
      ...
      return (e7, t5, s2, i3) => {
        ssrRenderSuspense(t5, { default: () => {
          unref(o6) ? t5("<div></div>") : unref(a3) ? t5(ssrRenderComponent(unref(Ce), { error: unref(a3) }, null, s2)) : unref(r4) ? t5(ssrRenderComponent(unref(IslandRenderer), { context: unref(r4) }, null, s2)) : unref(n2) ? renderVNode(t5, createVNode(resolveDynamicComponent(unref(n2)), null, null), s2) : t5(ssrRenderComponent(unref(we), null, null, s2));
        }, _: 1 });
      };
    } };
    ke = Pe.setup;
...
// .wrangler/tmp/pages-GpquVU/chunks/virtual/_virtual_spa-template.mjs
...
// .wrangler/tmp/pages-GpquVU/chunks/routes/renderer.mjs
...
function queueJob(e6) {
  $e2.length && $e2.includes(e6, Ae2 && e6.allowRecurse ? Te + 1 : Te) || (null == e6.id ? $e2.push(e6) : $e2.splice(function(e7) {
    let t4 = Te + 1, n2 = $e2.length;
    for (; t4 < n2; ) {
      const r4 = t4 + n2 >>> 1, o6 = $e2[r4], s2 = getId(o6);
...
function flushJobs(e6) {
  Oe = false, Ae2 = true, $e2.sort(comparator);
  try {
    for (Te = 0; Te < $e2.length; Te++) {
      const e7 = $e2[Te];
      e7 && false !== e7.active && callWithErrorHandling(e7, e7.i, e7.i ? 15 : 14);
    }
  } finally {
    Te = 0, $e2.length = 0, flushPostFlushCbs(), Ae2 = false, Me = null, ($e2.length || Ee.length) && flushJobs();
  }
}
    ...
    const { insert: t4, remove: n2, patchProp: r4, createElement: o6, createText: s2, createComment: i3, setText: a3, setElementText: l2, parentNode: c2, nextSibling: u3, setScopeId: p2 = NOOP, insertStaticContent: f2 } = e7, patch = (e8, t5, n3, r5 = null, o7 = null, s3 = null, i4 = void 0, a4 = null, l3 = !!t5.dynamicChildren) => {
      ...
      if (function(e9, t6, n4) {
        ...
        r5.next = t5, function(e9) {
          const t6 = $e2.indexOf(e9);
          t6 > Te && $e2.splice(t6, 1);
    ...
    BaseReactiveHandler = class {
      ...
      get(e6, t4, n2) {
        ...
        if ("__v_isShallow" === t4)
          return o6;
        if ("__v_raw" === t4)
          return n2 === (r4 ? o6 ? Ce2 : Se : o6 ? we2 : Re2).get(e6) || Object.getPrototypeOf(e6) === Object.getPrototypeOf(n2) ? e6 : void 0;
        const s2 = E(e6);
        if (!r4) {
          if (s2 && hasOwn(pe2, t4))
...
// .wrangler/tmp/pages-GpquVU/chunks/routes/api/teste.get.mjs
...
var init_teste_get = __esm({
  ".wrangler/tmp/pages-GpquVU/chunks/routes/api/teste.get.mjs"() {
    ...
    init_modules_watch_stub();
    init_runtime();
    e4 = defineEventHandler(async ({ context: o6 }) => (o6.cloudflare.env, console.log(o6.cloudflare), console.log("antes"), console.log("depois"), { data: "teste" }));
  }
});

// .wrangler/tmp/pages-GpquVU/chunks/runtime.mjs
...
function encodeQueryValue(e6) {
  return (t4 = "string" == typeof e6 ? e6 : JSON.stringify(e6), encodeURI("" + t4).replace(C2, "|")).replace(A3, "%2B").replace($2, "+").replace(R2, "%23").replace(I2, "%26").replace(T2, "`").replace(S2, "^").replace(x2, "%2F");
  var t4;
}
...
function parseURL(e6 = "", t4) {
  ...
  return { protocol: n2.toLowerCase(), auth: o6 ? o6.slice(0, Math.max(0, o6.length - 1)) : "", host: i3, pathname: u3, search: c2, hash: f2, [H2]: !n2 };
}
...
function stringifyParsedURL(e6) {
  ...
  return (e6.protocol || e6[H2] ? (e6.protocol || "") + "//" : "") + o6 + s2 + t4 + r4 + n2;
}
function objectHash(e6, t4) {
  const r4 = createHasher(t4 = t4 ? { ...P2, ...t4 } : P2);
...
function createHasher(e6) {
  ...
  return { toString: () => t4, getContext: () => r4, dispatch(t5) {
    ...
    if ("object" !== o6 && "function" !== o6 && "asyncfunction" !== o6)
      ...
      let n3 = [];
      false === e6.respectType || isNativeFunction(t5) || (n3 = z3), e6.excludeKeys && (r5 = r5.filter((t6) => !e6.excludeKeys(t6)), n3 = n3.filter((t6) => !e6.excludeKeys(t6))), write2("object:" + (r5.length + n3.length) + ":");
...
function isNativeFunction(e6) {
  return "function" == typeof e6 && Function.prototype.toString.call(e6).slice(-W2) === q3;
}
function hash(e6, t4 = {}) {
...
function useRuntimeConfig2(e6) {
  ...
  const t4 = klona(Pe3);
  return applyEnv(t4, ze2), e6.context.nitro.runtimeConfig = t4, t4;
}
...
var e5, t3, r3, n, o5, s, i2, a2, u2, c, f, l, h2, d, p, y2, g, m2, w2, b2, _getEnv, _2, v2, B2, R2, I2, x2, k2, A3, S2, T2, C2, $2, O2, j3, L2, N2, M2, U2, H2, P2, z3, q3, W2, WordArray, D2, F2, K2, Q2, BufferedBlockAlgorithm, Hasher, V2, G2, J2, SHA256, Y2, Z3, X2, ee3, te, re3, ne3, oe3, se3, _Readable, ie3, ae3, ue3, ce3, fe3, Socket, IncomingMessage, ServerResponse, le3, __publicField$2, H3Error, he3, de3, pe3, ye3, ge3, me3, we3, be3, _e3, __publicField, H3Event, ve2, lazyEventHandler, Be2, FetchError, Ee2, Re3, Ie2, xe3, ke3, Ae3, Se2, Te2, Ce3, $e, Oe2, je2, Le2, Hookable, Ne2, Me2, Ue2, He2, Pe3, ze2, qe2, We2, De2, memory, Fe2, normalizeKey2, Ke2, Qe2, Ve2, cachedFunction, cachedEventHandler, Ge2, Je2, errorHandler, _lazy_lFs6nj, Ye2, Ze2, useNitroApp, Xe2, et2, tt2, rt2;
var init_runtime = __esm({
  ".wrangler/tmp/pages-GpquVU/chunks/runtime.mjs"() {
    ...
    M2 = /\/$|\/\?|\/#/;
    U2 = /^\.?\//;
    H2 = Symbol.for("ufo:protocolRelative");
    P2 = Object.freeze({ ignoreUnknown: false, respectType: false, respectFunctionNames: false, respectFunctionProperties: false, unorderedObjects: true, unorderedArrays: false, unorderedSets: false, excludeKeys: void 0, excludeValues: void 0, replacer: void 0 });
    z3 = Object.freeze(["prototype", "__proto__", "constructor"]);
    q3 = "[native code] }";
    W2 = q3.length;
    WordArray = class {
      constructor(e6, t4) {
    ...
    Te2 = Ae3.Headers;
    Ce3 = Ae3.AbortController;
    $e = createFetch$1({ fetch: Se2, Headers: Te2, AbortController: Ce3 });
    ...
    Ue2 = /{{(.*?)}}/g;
    He2 = re3({ nuxt: {} });
    Pe3 = { app: { baseURL: "/", buildId: "3ab1d0f8-7ab7-47bf-bda7-f642e02b82f0", buildAssetsDir: "/_nuxt/", cdnURL: "" }, nitro: { envPrefix: "NUXT_", routeRules: { "/__nuxt_error": { cache: false }, "/_nuxt/builds/meta/**": { headers: { "cache-control": "public, max-age=31536000, immutable" } }, "/_nuxt/builds/**": { headers: { "cache-control": "public, max-age=1, immutable" } }, "/_nuxt/**": { headers: { "cache-control": "public, max-age=31536000, immutable" } } } }, public: {} };
    ze2 = { prefix: "NITRO_", altPrefix: Pe3.nitro.envPrefix ?? B2.env.NITRO_ENV_PREFIX ?? "_", envExpansion: Pe3.nitro.envExpansion ?? B2.env.NITRO_ENV_EXPANSION ?? false };
    qe2 = _deepFreeze(applyEnv(klona(Pe3), ze2));
    _deepFreeze(klona(He2)), new Proxy(/* @__PURE__ */ Object.create(null), { get: (e6, t4) => {
    ...
    et2 = { "/favicon.ico": { type: "image/vnd.microsoft.icon", etag: '"10be-n8egyE9tcb7sKGr/pYCaQ4uWqxI"', mtime: "2024-08-09T08:56:21.000Z", size: 4286, path: "../favicon.ico" }, "/robots.txt": { type: "text/plain; charset=utf-8", etag: '"1-rcg7GeeTSRscbqD9i0bNnzLlkvw"', mtime: "2024-08-09T08:56:21.000Z", size: 1, path: "../robots.txt" }, "/_nuxt/BAKNzro0.js": { type: "text/javascript; charset=utf-8", etag: '"1d2-2pLdl012GjKu9IfMUteD+cglMVQ"', mtime: "2024-08-20T00:50:29.097Z", size: 466, path: "../_nuxt/BAKNzro0.js" }, "/_nuxt/BT_PhuNT.js": { type: "text/javascript; charset=utf-8", etag: '"1f233-AOc+Xq2K40sSjUrgYtP1OJZ+I9g"', mtime: "2024-08-20T00:50:29.097Z", size: 127539, path: "../_nuxt/BT_PhuNT.js" }, "/_nuxt/BWTkOzGX.js": { type: "text/javascript; charset=utf-8", etag: '"2029-rM9nBb04tSeGo6gKgXZvJ0NgsWU"', mtime: "2024-08-20T00:50:29.098Z", size: 8233, path: "../_nuxt/BWTkOzGX.js" }, "/_nuxt/COS2-k3p.js": { type: "text/javascript; charset=utf-8", etag: '"ace-SbBxsvrYhgOrhwVXM6AOGdP05iY"', mtime: "2024-08-20T00:50:29.097Z", size: 2766, path: "../_nuxt/COS2-k3p.js" }, "/_nuxt/error-404.CjGVuf6H.css": { type: "text/css; charset=utf-8", etag: '"de4-SLOwa5sHvQIi2t5fYZEgfDusMUc"', mtime: "2024-08-20T00:50:29.096Z", size: 3556, path: "../_nuxt/error-404.CjGVuf6H.css" }, "/_nuxt/error-500.DFBAsgKS.css": { type: "text/css; charset=utf-8", etag: '"75c-I8wgoT19gdl/gPtizNKXfkn+TtQ"', mtime: "2024-08-20T00:50:29.096Z", size: 1884, path: "../_nuxt/error-500.DFBAsgKS.css" }, "/_nuxt/builds/latest.json": { type: "application/json", etag: '"47-1xlFTLfBSw+cL/x70DK6fCzzyy4"', mtime: "2024-08-20T00:50:30.367Z", size: 71, path: "../_nuxt/builds/latest.json" }, "/_nuxt/builds/meta/3ab1d0f8-7ab7-47bf-bda7-f642e02b82f0.json": { type: "application/json", etag: '"8b-4vm//CvbM1vdfvX2FBL8j3/H55c"', mtime: "2024-08-20T00:50:30.368Z", size: 139, path: "../_nuxt/builds/meta/3ab1d0f8-7ab7-47bf-bda7-f642e02b82f0.json" } };
...
// .wrangler/tmp/bundle-SFMnVc/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-SFMnVc/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/pages-GpquVU/mpqjea6c0x.js
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/pages-GpquVU/bundledWorker-0.330194628994964.mjs
init_checked_fetch();
init_modules_watch_stub();
init_runtime();
...
//# sourceMappingURL=mpqjea6c0x.js.map
